...
export default function Edit( { attributes, setAttributes } ) {
	...
	return (
		<div { ...useBlockProps() }>
			<InspectorControls>
				<PanelBody
					title={ __( 'Block Settings', 'degree-search-widget' ) }
					initialOpen={ true }
				>
					{ loadingAreas ? (
						<Spinner />
						...
						<SelectControl
							...
							onChange={ ( newValue ) =>
								setAttributes( { areaOfStudy: newValue } )
							}
						/>
					) }
					...
					{ loadingPages ? (
						...
						<SelectControl
							...
							onChange={ ( newPage ) =>
								setAttributes( { degreeSearchPage: newPage } )
							}
						/>
					) }
				</PanelBody>
			...
			<div
				id="degree-search-widget"
				className="programs-search-container"
			>
				<div className="programs-search-form">
					<div className="programs-search-wrap">
						...
						<button
							type="button"
							className="wp-element-button button-submit"
						>
							Search
						</button>
					</div>
						...
						<p>
							<strong>
								{ attributes.degreeSearchPage
									...
									: __(
											'Please choose a Degree Search Page',
											'degree-search-widget'
									  ) }
							</strong>
						</p>
