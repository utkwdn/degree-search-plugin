...
"use strict";
/*!*******************************************!*\
  !*** ./src/degree-search-utility/view.js ***!
  \*******************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
...
/* harmony import */ var react_bootstrap_Placeholder__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! react-bootstrap/Placeholder */ "./node_modules/react-bootstrap/esm/Placeholder.js");
...
function View() {
  ...
  const [resultsPerPage] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(20);
  const [pagesLoaded, setPagesLoaded] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(1);
  ...
  const fetchController = (0,react__WEBPACK_IMPORTED_MODULE_1__.useRef)(null);
  const searchTimeout = (0,react__WEBPACK_IMPORTED_MODULE_1__.useRef)(null);
  const [searchTerm, setSearchTerm] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(new URLSearchParams(window.location.search).get('search') || '');
  const [degreeTypeFilter, setDegreeTypeFilter] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(new URLSearchParams(window.location.search).get('degree_type') || '');
  const [areaFilter, setAreaFilter] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(new URLSearchParams(window.location.search).get('area') || '');
  const [areaFilterName, setAreaFilterName] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)('');
  const [collegeFilter, setCollegeFilter] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(new URLSearchParams(window.location.search).get('college') || '');
  const [collegeFilterName, setCollegeFilterName] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)('');
  const [onlineFilter, setOnlineFilter] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(new URLSearchParams(window.location.search).get('online') || '');
  const [areaMap, setAreaMap] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
  const [collegeMap, setCollegeMap] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
  const fetchPrograms = (page = 1, append = false, signal) => {
    ...
    _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_0___default()({
      ...
      signal,
      parse: false
    }) // Use parse: false to access headers
    .then(response => {
      ...
      const formattedPrograms = data.map(program => {
        ...
        // Extract Degrees
        const degrees = program._embedded?.["wp:term"]?.flat().filter(term => term.taxonomy === "degree").map(degree => ({
          id: degree.id,
          name: degree.name,
        ...
        const concentrations = program._embedded?.["wp:term"]?.flat().filter(term => term.taxonomy === "concentration").map(concentration => {
          var _concentration$acf$on;
          return {
            id: concentration.id,
            name: concentration.name.replace(' (Online)', ''),
            online: (_concentration$acf$on = concentration.acf?.online) !== null && _concentration$acf$on !== void 0 ? _concentration$acf$on : false
          };
        }) || [];
        return {
          id: program.id,
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    ...
    searchTimeout.current = setTimeout(() => {
      ...
      const {
        signal
      } = fetchController.current; // Get the signal for the fetch request
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    ...
    _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_0___default()({
      path: '/wp/v2/college?per_page=50'
    }).then(data => {
      if (Array.isArray(data)) {
  ...
  const displayPlaceholders = (numItems = 3) => {
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.Fragment, {
      children: Array.from({
        length: numItems
      }).map((_, index) => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)("li", {
        className: "programEntry",
        children: Array.from({
          length: 3
        }).map((_, subIndex) => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)("ol", {
          className: "concentrationList",
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)(react_bootstrap_Placeholder__WEBPACK_IMPORTED_MODULE_4__["default"], {
            as: "li",
            animation: "glow",
            children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)(react_bootstrap_Placeholder__WEBPACK_IMPORTED_MODULE_4__["default"], {
              xs: 12,
...
const root = (0,react_dom_client__WEBPACK_IMPORTED_MODULE_2__.createRoot)(document.getElementById('filters'));
root.render(/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)(View, {}));
})();
